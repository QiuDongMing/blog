package com.coderme.sercurity.utils;
import com.alibaba.fastjson.JSON;
import com.coderme.blog.user.data.UserOpenInfo;
import com.coderme.common.base.utils.StringUtils;
...
public class JwtTokenUtil {
    ...
    public static String generateToken(UserOpenInfo userOpenInfo) {
        return generateToken(userOpenInfo, TimeUnit.MINUTES, 10L, null );
    }
    ...
    public static String generateToken(UserOpenInfo userOpenInfo, String subject) {
        return generateToken(userOpenInfo, TimeUnit.SECONDS, 30L, subject);
    }
